...
class LLMClient:
    ...
    def _setup_local_pipeline(self):
        ...
        model = AutoModelForCausalLM.from_pretrained(
            ...
            attn_implementation="eager"  # <-- ADDED THIS LINE to ensure compatibility with older GPUs
        )
        ...
        try:
            if self.model_type in self.LOCAL_MODELS:
                ...
                outputs = self.pipe(
                    ...
                    temperature=0.7,
                    top_p=0.95,
                    pad_token_id=self.pipe.tokenizer.eos_token_id  # Set pad token to avoid warning
                )
