...
class LLMClient:
    ...
    def __init__(self, model_type: 'ModelType'):
        ...
        # --- MODIFIED: Differentiate between local and API models ---
        self.LOCAL_MODELS = [ModelType.MISTRAL_7B_INSTRUCT]
    ...
    def _setup_api_client(self):
        ...
        api_key_map = {
            ...
            ModelType.CLAUDE_3_SONNET: ("ANTHROPIC_API_KEY", "Anthropic"),
            ModelType.CLAUDE_3_HAIKU: ("ANTHROPIC_API_KEY", "Anthropic"),
    ...
    def get_response(self, system_prompt: str, user_prompt: str) -> str:
        ...
        """
        try:
            # --- MODIFIED: Handle local model inference ---
            if self.model_type in self.LOCAL_MODELS:
                messages = [{"role": "system", "content": system_prompt}, {"role": "user", "content": user_prompt}]

                # Define terminators for Mistral Instruct models
                terminators = [
                ...
                # Parse the complex output from the pipeline
            ...
            # --- Existing API-based logic ---
            elif self.model_type in [ModelType.GPT_4o, ModelType.GPT_4o_MINI, ModelType.DEEPSEEK_V3]:
                ...
                response = self.client.messages.create(model=self.model_name, system=system_prompt,
...
class ModelType(Enum):
    ...
    MISTRAL_7B_INSTRUCT = "mistralai/Mistral-7B-Instruct-v0.3"  # <-- ADDED MISTRAL
...
def _execute_questions(client: LLMClient, culture: CultureType, survey_name: str, questions: list, system_prompt: str,
    ...
    for i, question_text in enumerate(questions, 1):
        print(f"  [Question {i}/{total_questions}]──> {question_text[:70]}...")  # Truncate long questions for display
...
def run_aispi_survey(client: LLMClient, culture: CultureType, run_number: int):
    statements = [
        ...
        "AI will advance sustainable development.", "AI and sustainable development go along very well.",
